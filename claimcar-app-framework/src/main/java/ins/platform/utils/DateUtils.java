...
public class DateUtils {
	...
	/*** 年到秒数日期格式 yyyyMMddHHmmss */
	public static final String YMDHMSS = "yyyyMMddHHss";
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(DateUtils.compareMinutes(DateUtils.strToDate("20181203111937", YMDHMSS),new Date("2018/12/3 8:48:00")));
