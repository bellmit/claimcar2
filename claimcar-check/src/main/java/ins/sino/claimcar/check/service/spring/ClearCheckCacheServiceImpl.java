...
/**
 * description: ClearCheckCacheServiceImpl
 * date: 2020/12/8 14:58
 * author: lk
 * version: 1.0
 */
@Service(protocol = {"dubbo"}, validation = "true", registry = {"default"}, group = "clearCheckCacheService")
@Path("clearCheckCacheService")
public class ClearCheckCacheServiceImpl implements ClearCacheService {
    @Autowired
