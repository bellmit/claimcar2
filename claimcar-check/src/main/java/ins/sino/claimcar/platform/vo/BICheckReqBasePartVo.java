/******************************************************************************
 * CREATETIME : 2016年4月27日 上午11:39:45
 ******************************************************************************/
...
/**
 * 车险信息平台交强险V6.0.0接口 -->查勘登记vo -->商业-->请求报文基本信息
 * @author ★Luwei
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class BICheckReqBasePartVo {
	...
	private String lossCauseCode;// 出险原因代码；参见代码
	...
	/**
	 * @return 返回 lossCauseCode 出险原因代码；参见代码
	 */
	...
	/**
	 * @param lossCauseCode 要设置的 出险原因代码；参见代码
	 */
