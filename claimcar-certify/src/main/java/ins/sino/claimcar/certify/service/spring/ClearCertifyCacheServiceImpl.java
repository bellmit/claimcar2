...
/**
 * description: ClearCertifyCacheServiceImpl
 * date: 2020/12/8 14:25
 * author: lk
 * version: 1.0
 */
@Service(protocol = {"dubbo"}, validation = "true", registry = {"default"}, group = "clearCertifyCacheService")
@Path("clearCertifyCacheService")
public class ClearCertifyCacheServiceImpl implements ClearCacheService {
    @Autowired
