...
public class BiSubrogationDataVo {
	@XmlElement(name = "LinkerName")
	private String linkerName;//责任对方联系人姓名/名称
	...
	private String engineNo;//责任对方车辆VIN码
	...
	/** 
	 * @return 返回 linkerName  责任对方联系人姓名/名称
	 */ 
	...
	/** 
	 * @param linkerName 要设置的 责任对方联系人姓名/名称
	 */ 
	...
	/** 
	 * @return 返回 vIN  责任对方车辆发动机号
	 */
	public String getvIN() {
		return vIN;
	}
	/** 
	 * @param vIN 要设置的 责任对方车辆发动机号
	 */
	...
	/** 
	 * @param engineNo 要设置的 责任对方车辆VIN码
	 */ 
