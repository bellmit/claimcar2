...
public class LeapLocator extends org.apache.axis.client.Service implements ins.sino.claimcar.longrise.hnServices.Leap {
    ...
    private java.lang.String leapPort_address = "http://59.173.241.186:8042/HNIS/services/com.longrise.services.leap";
    ...
    public ins.sino.claimcar.longrise.hnServices.Ileap getleapPort() throws javax.xml.rpc.ServiceException {
    ...
    public ins.sino.claimcar.longrise.hnServices.Ileap getleapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ins.sino.claimcar.longrise.hnServices.LeapSoapBindingStub _stub = new ins.sino.claimcar.longrise.hnServices.LeapSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ins.sino.claimcar.longrise.hnServices.Ileap.class.isAssignableFrom(serviceEndpointInterface)) {
                ins.sino.claimcar.longrise.hnServices.LeapSoapBindingStub _stub = new ins.sino.claimcar.longrise.hnServices.LeapSoapBindingStub(new java.net.URL(leapPort_address), this);
                _stub.setPortName(getleapPortWSDDServiceName());
                return _stub;
            }
        }
