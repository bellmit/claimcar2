...
public class CaseBean
{
    ...
    private String istatus="无";// 返回状态
    private String resultdesc="无";// 返回信息
    
    private String xzname;// 险种名称
    private String reopenno;// 重开赔案
    private String isba;// 是否报案
    private String caseinfotype;//案件类型
    private String cxzy;//出险摘要
    private String garage;//修理厂名称
	...
	public void setReopenno(String reopenno) {
		this.reopenno = reopenno;
	}
	...
	public void setCaseinfotype(String caseinfotype) {
		this.caseinfotype = caseinfotype;
	}
	public String getCxzy() {
		return cxzy;
	}
	public void setCxzy(String cxzy) {
		this.cxzy = cxzy;
	}
