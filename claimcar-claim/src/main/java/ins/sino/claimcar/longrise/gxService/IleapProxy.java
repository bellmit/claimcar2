...
public class IleapProxy implements ins.sino.claimcar.longrise.gxService.Ileap {
  private String _endpoint = null;
  private ins.sino.claimcar.longrise.gxService.Ileap ileap = null;
  ...
  private void _initIleapProxy() {
    try {
      ileap = (new ins.sino.claimcar.longrise.gxService.LeapLocator()).getleapPort();
      if (ileap != null) {
        if (_endpoint != null)
  ...
  public ins.sino.claimcar.longrise.gxService.Ileap getIleap() {
    if (ileap == null)
      _initIleapProxy();
    return ileap;
  }
