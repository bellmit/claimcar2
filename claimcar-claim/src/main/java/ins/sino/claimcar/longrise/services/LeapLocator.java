...
public class LeapLocator extends org.apache.axis.client.Service implements ins.sino.claimcar.longrise.services.Leap {
    ...
    private java.lang.String leapPort_address = "http://59.173.241.186/GZIS/services/com.longrise.services.leap";
    ...
    public ins.sino.claimcar.longrise.services.Ileap getleapPort() throws javax.xml.rpc.ServiceException {
    ...
    public ins.sino.claimcar.longrise.services.Ileap getleapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ins.sino.claimcar.longrise.services.LeapSoapBindingStub _stub = new ins.sino.claimcar.longrise.services.LeapSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ins.sino.claimcar.longrise.services.Ileap.class.isAssignableFrom(serviceEndpointInterface)) {
                ins.sino.claimcar.longrise.services.LeapSoapBindingStub _stub = new ins.sino.claimcar.longrise.services.LeapSoapBindingStub(new java.net.URL(leapPort_address), this);
                _stub.setPortName(getleapPortWSDDServiceName());
                return _stub;
            }
        }
