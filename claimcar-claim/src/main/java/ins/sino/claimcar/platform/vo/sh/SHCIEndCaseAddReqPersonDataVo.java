/******************************************************************************
 * CREATETIME : 2016年6月1日 上午10:23:54
 ******************************************************************************/
...
public class SHCIEndCaseAddReqPersonDataVo {
	...
	private List<SHCIEndCaseAddReqPersonLossPartDataVo> lossPartDataVo;
	...
	private List<SHCIEndCaseAddReqInjuryDataVo> injuryDataVo;
	...
	private List<SHCIEndCaseAddReqHospitalInfoDataVo> hospitalInfoDataVo;
	...
	private Double underDefloss;// 医疗审核金额,@金额说明：保险公司核心系统中伤亡人员医疗审核通过时的金额
	...
	public List<SHCIEndCaseAddReqPersonLossPartDataVo> getLossPartDataVo() {
		return lossPartDataVo;
	}

	public void setLossPartDataVo(List<SHCIEndCaseAddReqPersonLossPartDataVo> lossPartDataVo) {
		this.lossPartDataVo = lossPartDataVo;
	}

	public List<SHCIEndCaseAddReqInjuryDataVo> getInjuryDataVo() {
		return injuryDataVo;
	}

	public void setInjuryDataVo(List<SHCIEndCaseAddReqInjuryDataVo> injuryDataVo) {
		this.injuryDataVo = injuryDataVo;
	}

	public List<SHCIEndCaseAddReqHospitalInfoDataVo> getHospitalInfoDataVo() {
		return hospitalInfoDataVo;
	}

	public void setHospitalInfoDataVo(List<SHCIEndCaseAddReqHospitalInfoDataVo> hospitalInfoDataVo) {
	...
	public void setInjuryIdentifyInfoData(
		...
		InjuryIdentifyInfoData = injuryIdentifyInfoData;
	}
