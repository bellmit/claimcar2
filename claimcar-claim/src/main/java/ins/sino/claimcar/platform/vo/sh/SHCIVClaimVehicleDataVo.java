/******************************************************************************
 * CREATETIME : 2016年5月31日 下午6:47:36
 ******************************************************************************/
...
public class SHCIVClaimVehicleDataVo {
	...
	private List<SHCIVClaimCarLossPartDataVo> lossPartList;

	@XmlElementWrapper(name = "FITTING_LIST")
	@XmlElement(name = "FITTING_DATA")
	private List<SHCIVClaimFittingDataVo> fittingList;

	@XmlElementWrapper(name = "REPAIR_LIST")
	@XmlElement(name = "REPAIR_DATA")
	private List<SHCIVClaimRepairDataVo> repairList;

	@XmlElementWrapper(name = "ActuralRepairList")
	@XmlElement(name = "ActuralRepairData")
	private List<SHCIVClaimActuralRepairDataVo> acturalRepairList;
	...
	/**
	 * @param priceSltCode 要设置的 价格方案代码
	 */
	...
	/**
	 * @param certitype 要设置的 出险车辆驾驶员证件类型
	 */
	 ...
	 */
	public List<SHCIVClaimCarLossPartDataVo> getLossPartList() {
		return lossPartList;
	}
	 ...
	 */
	public void setLossPartList(List<SHCIVClaimCarLossPartDataVo> lossPartList) {
	 ...
	 */
	public List<SHCIVClaimFittingDataVo> getFittingList() {
		return fittingList;
	}
	 ...
	 */
	public void setFittingList(List<SHCIVClaimFittingDataVo> fittingList) {
	 ...
	 */
	public List<SHCIVClaimRepairDataVo> getRepairList() {
		return repairList;
	}

	/**
	 * @param repairList 要设置的 repairList。
	 */
	public void setRepairList(List<SHCIVClaimRepairDataVo> repairList) {
	 ...
	 */
	public List<SHCIVClaimActuralRepairDataVo> getActuralRepairList() {
		return acturalRepairList;
	}

	/**
	 * @param acturalRepairList 要设置的 acturalRepairList。
	 */
	public void setActuralRepairList(List<SHCIVClaimActuralRepairDataVo> acturalRepairList) {
