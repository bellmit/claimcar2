/******************************************************************************
 * CREATETIME : 2016年5月31日 下午4:18:53
 ******************************************************************************/
...
public class SHCIVClaimPersonDataVo {
	...
	private List<SHCIVClaimPersLossPartDataVo> lossPartList;

	@XmlElementWrapper(name = "InjuryList")
	@XmlElement(name = "InjuryData")
	private List<SHCIVClaimInjuryDataVo> injuryList;

	@XmlElementWrapper(name = "HospitalInfoList")
	@XmlElement(name = "HospitalInfoData")
	private List<SHCIVClaimHospitalInfoDataVo> hospitalInfoList;
	 ...
	 */
	public List<SHCIVClaimPersLossPartDataVo> getLossPartList() {
		return lossPartList;
	}
	 ...
	 */
	public void setLossPartList(List<SHCIVClaimPersLossPartDataVo> lossPartList) {
	 ...
	 */
	public List<SHCIVClaimInjuryDataVo> getInjuryList() {
		return injuryList;
	}
	 ...
	 */
	public void setInjuryList(List<SHCIVClaimInjuryDataVo> injuryList) {
	 ...
	 */
	public List<SHCIVClaimHospitalInfoDataVo> getHospitalInfoList() {
	 ...
	 */
	public void setHospitalInfoList(List<SHCIVClaimHospitalInfoDataVo> hospitalInfoList) {
