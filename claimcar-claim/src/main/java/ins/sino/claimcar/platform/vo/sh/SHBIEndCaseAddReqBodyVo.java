/******************************************************************************
 * CREATETIME : 2016年6月1日 下午3:46:56
 ******************************************************************************/
...
/**
 * 结案追加请求上海平台信息BodyVo类-商业
 * @author ★Luwei
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "BODY")
public class SHBIEndCaseAddReqBodyVo {
	...
	private List<SHBIEndCaseAddReqVehicleDataVo> vehicleDataVo;
	...
	public List<SHBIEndCaseAddReqVehicleDataVo> getVehicleDataVo() {
		return vehicleDataVo;
	}

	public void setVehicleDataVo(List<SHBIEndCaseAddReqVehicleDataVo> vehicleDataVo) {
