/******************************************************************************
 * CREATETIME : 2016年5月24日 下午5:25:17
 ******************************************************************************/
 ...
 * @author ★XMSH
 */
public class BiEndCaseResLockedDataVo {
	...
	private String insurerCode;// 对方保险公司代码，四位标准的公司名称简写；参见代码
	...
	private String errorDesc;// 跨省数据同步失败描述
	...
	/**
	 * @return 返回 insurerCode 对方保险公司代码，四位标准的公司名称简写；参见代码
	 */
	...
	/**
	 * @param insurerCode 要设置的 对方保险公司代码，四位标准的公司名称简写；参见代码
	 */
	...
	/**
	 * @return 返回 errorDesc 跨省数据同步失败描述
	 */
	...
	/**
	 * @param errorDesc 要设置的 跨省数据同步失败描述
	 */
