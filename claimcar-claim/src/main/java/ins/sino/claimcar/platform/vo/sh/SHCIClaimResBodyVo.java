/******************************************************************************
 * CREATETIME : 2016年5月30日 下午1:21:25
 ******************************************************************************/
...
/**
 * 立案--请求上海平台信息--返回BodyVo类-交强
 * @author ★Luwei
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "BODY")
public class SHCIClaimResBodyVo {
	...
	private List<SHCIClaimResClaimDataVo> claimDataVo;
	...
	public List<SHCIClaimResClaimDataVo> getClaimDataVo() {
		return claimDataVo;
	}

	public void setClaimDataVo(List<SHCIClaimResClaimDataVo> claimDataVo) {
