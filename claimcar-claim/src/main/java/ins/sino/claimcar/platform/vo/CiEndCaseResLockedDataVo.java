/******************************************************************************
 * CREATETIME : 2016年5月24日 下午3:44:34
 ******************************************************************************/
 ...
 * @author ★XMSH
 */
public class CiEndCaseResLockedDataVo {
	...
	@XmlElement(name = "KS_ERROR_DESC")
	private String ksErrorDesc;// 跨省数据同步失败描述
	...
	/**
	 * @return 返回 ksErrorDesc 跨省数据同步失败描述
	 */
	public String getKsErrorDesc() {
		return ksErrorDesc;
	}

	/**
	 * @param ksErrorDesc 要设置的 跨省数据同步失败描述
	 */
	public void setKsErrorDesc(String ksErrorDesc) {
		this.ksErrorDesc = ksErrorDesc;
	}
