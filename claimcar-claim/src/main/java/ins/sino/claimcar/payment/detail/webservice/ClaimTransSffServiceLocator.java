...
public class ClaimTransSffServiceLocator extends org.apache.axis.client.Service implements ins.sino.claimcar.payment.detail.webservice.ClaimTransSffService {
    ...
    private java.lang.String ClaimTransSffPort_address = "http://10.236.0.205:8080/payment/service/claimTransSff";
    ...
    public ins.sino.claimcar.payment.detail.webservice.ClaimTransSff getClaimTransSffPort() throws javax.xml.rpc.ServiceException {
    ...
    public ins.sino.claimcar.payment.detail.webservice.ClaimTransSff getClaimTransSffPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ins.sino.claimcar.payment.detail.webservice.ClaimTransSffPortBindingStub _stub = new ins.sino.claimcar.payment.detail.webservice.ClaimTransSffPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ins.sino.claimcar.payment.detail.webservice.ClaimTransSff.class.isAssignableFrom(serviceEndpointInterface)) {
                ins.sino.claimcar.payment.detail.webservice.ClaimTransSffPortBindingStub _stub = new ins.sino.claimcar.payment.detail.webservice.ClaimTransSffPortBindingStub(new java.net.URL(ClaimTransSffPort_address), this);
                _stub.setPortName(getClaimTransSffPortWSDDServiceName());
                return _stub;
            }
        }
