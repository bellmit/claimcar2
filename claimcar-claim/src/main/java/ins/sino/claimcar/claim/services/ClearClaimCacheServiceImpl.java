...
/**
 * description: ClearClaimCacheServiceImpl
 * date: 2020/12/8 15:02
 * author: lk
 * version: 1.0
 */
@Service(protocol = {"dubbo"}, validation = "true", registry = {"default"}, group = "clearClaimCacheService")
@Path("clearClaimCacheService")
public class ClearClaimCacheServiceImpl implements ClearCacheService {
    @Autowired
