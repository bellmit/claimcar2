...
@ContextConfiguration(locations = {"classpath*:spring/applicationContext.xml","classpath*:spring/applicationContext-hibernate.xml","classpath*:spring/dataAccessContext-test.xml"})
