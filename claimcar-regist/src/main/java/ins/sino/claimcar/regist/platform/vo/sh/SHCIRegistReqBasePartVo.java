/******************************************************************************
 * CREATETIME : 2016年5月24日 下午3:50:28
 ******************************************************************************/
...
public class SHCIRegistReqBasePartVo {
	...
	@XmlElement(name = "SPECIAL_REPORT_NO")
	private String specialReportNo;// 特殊报案号
	...
	/**
	 * @return 返回 specialReportNo 特殊报案号
	 */
	public String getSpecialReportNo() {
		return specialReportNo;
	}

	/**
	 * @param specialReportNo 要设置的 特殊报案号
	 */
	public void setSpecialReportNo(String specialReportNo) {
		this.specialReportNo = specialReportNo;
	}
