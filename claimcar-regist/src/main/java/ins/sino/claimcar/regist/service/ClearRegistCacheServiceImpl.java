...
/**
 * description: ClearRegistCacheServiceImpl
 * date: 2020/12/8 15:17
 * author: lk
 * version: 1.0
 */
@Service(protocol = {"dubbo"}, validation = "true", registry = {"default"}, group = "clearRegistCacheService")
@Path("clearRegistCacheService")
public class ClearRegistCacheServiceImpl implements ClearCacheService {
    @Autowired
