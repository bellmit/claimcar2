...
/**
 * POJO Class PrpLCInsuredId
 */
@Embeddable
public class PrpLCInsuredId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLCInsuredId)) {
			return false;
		}
		PrpLCInsuredId castOther = (PrpLCInsuredId) other;  
