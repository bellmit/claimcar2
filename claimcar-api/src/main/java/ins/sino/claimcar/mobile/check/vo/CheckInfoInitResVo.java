 ...
 */
@XStreamAlias("PACKET")
public class CheckInfoInitResVo  implements Serializable{
	...
	@XStreamAlias("BODY") 
	private CheckInfoInitResBodyVo body;
	...
	public CheckInfoInitResBodyVo getBody() {
		return body;
	}

	public void setBody(CheckInfoInitResBodyVo body) {
		this.body = body;
	}
