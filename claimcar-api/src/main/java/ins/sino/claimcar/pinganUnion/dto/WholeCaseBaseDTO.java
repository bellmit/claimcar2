 ...
 */
public class WholeCaseBaseDTO implements Serializable {
    //报案号
    private String reportNo;
    //赔付次数
    private Integer caseTimes;
    //整案件状态 0-已结案 1-已报案 2-已理算
    private String wholeCaseStatus;
    //赔付结论  1-赔付 2-零结 3-商业险拒赔 4-整案拒赔 5-注销
    private String indemnityConclusion;
    //赔付方式  1-按责赔付 2-互碰自赔 3-各自修车 4-特殊调解
