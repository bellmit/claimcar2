...
public class SdSzResponseVo implements java.io.Serializable{
    ...
    private String returnCode;//服务接口名称（见3.4接口列表中的请求方法名）
    private String returnMsg;//服务接口名称（见3.4接口列表中的请求方法名）
    private String data;//业务数据加密字符串（加密方式见”4.2对称加密”章节）
