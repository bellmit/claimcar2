...
/**
 * Vo Base Class of PO PrpLScheduleTask
 */ 
public class PrpLScheduleTaskVoBase implements java.io.Serializable {
	...
	private List<PrpLScheduleTasklogVo> prpLScheduleTasklogs = new ArrayList<PrpLScheduleTasklogVo>(0);
	private List<PrpLScheduleDefLossVo> prpLScheduleDefLosses = new ArrayList<PrpLScheduleDefLossVo>(0);
	private List<PrpLScheduleItemsVo> prpLScheduleItemses = new ArrayList<PrpLScheduleItemsVo>(0);

    protected PrpLScheduleTaskVoBase() {
	...
	public List<PrpLScheduleTasklogVo> getPrpLScheduleTasklogs() {
		return this.prpLScheduleTasklogs;
	}

	public void setPrpLScheduleTasklogs(List<PrpLScheduleTasklogVo> prpLScheduleTasklogs) {
		this.prpLScheduleTasklogs = prpLScheduleTasklogs;
	}

	public List<PrpLScheduleDefLossVo> getPrpLScheduleDefLosses() {
		return this.prpLScheduleDefLosses;
	}

	public void setPrpLScheduleDefLosses(List<PrpLScheduleDefLossVo> prpLScheduleDefLosses) {
		this.prpLScheduleDefLosses = prpLScheduleDefLosses;
	}

	public List<PrpLScheduleItemsVo> getPrpLScheduleItemses() {
		return this.prpLScheduleItemses;
	}

	public void setPrpLScheduleItemses(List<PrpLScheduleItemsVo> prpLScheduleItemses) {
