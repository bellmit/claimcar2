...
/**
 * Vo Base Class of PO PrpLDlossCarRepairHis
 */ 
public class PrpLDlossCarRepairHisVoBase implements java.io.Serializable {
    ...
    protected PrpLDlossCarRepairHisVoBase() {
