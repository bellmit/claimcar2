...
/**
 * Vo Base Class of PO PrpLRuleDetailInfoId
 */ 
public class PrpLRuleDetailInfoIdVoBase implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private String ruleId;
	private int serialNo;
	private String ruleNode;

    protected PrpLRuleDetailInfoIdVoBase() {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLRuleDetailInfoIdVo)) {
			return false;
		}
		PrpLRuleDetailInfoIdVo castOther = (PrpLRuleDetailInfoIdVo) other;  
