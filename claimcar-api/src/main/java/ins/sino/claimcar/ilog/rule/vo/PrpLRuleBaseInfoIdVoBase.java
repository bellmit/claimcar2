...
/**
 * Vo Base Class of PO PrpLRuleBaseInfoId
 */ 
public class PrpLRuleBaseInfoIdVoBase implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private String ruleId;
	private String ruleNode;

    protected PrpLRuleBaseInfoIdVoBase() {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLRuleBaseInfoIdVo)) {
			return false;
		}
		PrpLRuleBaseInfoIdVo castOther = (PrpLRuleBaseInfoIdVo) other;  
