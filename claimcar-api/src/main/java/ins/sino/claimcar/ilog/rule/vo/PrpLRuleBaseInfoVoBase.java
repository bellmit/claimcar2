...
/**
 * Vo Base Class of PO PrpLRuleBaseInfo
 */ 
public class PrpLRuleBaseInfoVoBase implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private PrpLRuleBaseInfoIdVo id;
	...
	protected PrpLRuleBaseInfoVoBase() {
	
    }

    
	public PrpLRuleBaseInfoIdVo getId() {
		return this.id;
	}

	public void setId(PrpLRuleBaseInfoIdVo id) {
		this.id = id;
	}
