...
/**
 * Vo Base Class of PO PrpLRuleBaseInfoHisId
 */ 
public class PrpLRuleBaseInfoHisIdVoBase implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private String ruleId;
	private String ruleNode;

    protected PrpLRuleBaseInfoHisIdVoBase() {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLRuleBaseInfoHisIdVo)) {
			return false;
		}
		PrpLRuleBaseInfoHisIdVo castOther = (PrpLRuleBaseInfoHisIdVo) other;  
