...
/**
 * Vo Base Class of PO PrpLRuleDetailInfo
 */ 
public class PrpLRuleDetailInfoVoBase implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private PrpLRuleDetailInfoIdVo id;
    ...
    protected PrpLRuleDetailInfoVoBase() {
	
    }

    
	public PrpLRuleDetailInfoIdVo getId() {
		return this.id;
	}

	public void setId(PrpLRuleDetailInfoIdVo id) {
		this.id = id;
	}
