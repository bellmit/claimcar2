...
public class MTACarInfoVo implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	@XStreamAlias("DRIVER")
	private MTADriverVo driver; //驾驶员信息
	
	@XStreamAlias("CHECK")
	private MTACheckVo check; //查勘信息
	...
	public MTADriverVo getDriver() {
		return driver;
	}

	public void setDriver(MTADriverVo driver) {
		this.driver = driver;
	}

	public MTACheckVo getCheck() {
		return check;
	}

	public void setCheck(MTACheckVo check) {
		this.check = check;
	}
