...
/**
 * Vo Base Class of PO PrpLDlossPersTraceHis
 */ 
public class PrpLDlossPersTraceHisVoBase implements java.io.Serializable {
	...
	private List<PrpLDlossPersTraceFeeHisVo> prpLDlossPersTraceFeeHises = new ArrayList<PrpLDlossPersTraceFeeHisVo>(0);

    protected PrpLDlossPersTraceHisVoBase() {
	...
	public List<PrpLDlossPersTraceFeeHisVo> getPrpLDlossPersTraceFeeHises() {
		return this.prpLDlossPersTraceFeeHises;
	}

	public void setPrpLDlossPersTraceFeeHises(List<PrpLDlossPersTraceFeeHisVo> prpLDlossPersTraceFeeHises) {
