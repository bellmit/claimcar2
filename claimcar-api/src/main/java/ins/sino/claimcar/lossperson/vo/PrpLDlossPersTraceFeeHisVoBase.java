...
/**
 * Vo Base Class of PO PrpLDlossPersTraceFeeHis
 */ 
public class PrpLDlossPersTraceFeeHisVoBase implements java.io.Serializable {
    ...
    protected PrpLDlossPersTraceFeeHisVoBase() {
