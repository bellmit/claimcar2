...
/**
 * POJO Class PrpLRuleBaseInfoHisId
 */
@Embeddable
public class PrpLRuleBaseInfoHisId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLRuleBaseInfoHisId)) {
			return false;
		}
		PrpLRuleBaseInfoHisId castOther = (PrpLRuleBaseInfoHisId) other;  
