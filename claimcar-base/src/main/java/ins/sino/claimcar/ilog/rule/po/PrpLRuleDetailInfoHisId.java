...
/**
 * POJO Class PrpLRuleDetailInfoHisId
 */
@Embeddable
public class PrpLRuleDetailInfoHisId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLRuleDetailInfoHisId)) {
			return false;
		}
		PrpLRuleDetailInfoHisId castOther = (PrpLRuleDetailInfoHisId) other;  
