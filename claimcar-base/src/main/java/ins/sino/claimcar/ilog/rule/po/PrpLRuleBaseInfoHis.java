...
/**
 * POJO Class PrpLRuleBaseInfoHis
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@TableGenerator(name = "utiSequence", table = "UTISEQUENCE", pkColumnName = "GenName", valueColumnName = "GenValue", pkColumnValue = "PRPLRULEBASEINFOHIS_PK", allocationSize = 10)
@Table(name = "PRPLRULEBASEINFOHIS")
public class PrpLRuleBaseInfoHis implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private PrpLRuleBaseInfoHisId id;
	...
	public PrpLRuleBaseInfoHisId getId() {
		return this.id;
	}

	public void setId(PrpLRuleBaseInfoHisId id) {
		this.id = id;
	}
	...
	@Column(name = "UNDERWRITERFLAG", nullable = false, length=1)
