...
/**
 * POJO Class PrpLRuleDetailInfo
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@TableGenerator(name = "utiSequence", table = "UTISEQUENCE", pkColumnName = "GenName", valueColumnName = "GenValue", pkColumnValue = "PRPLRULEDETAILINFO_PK", allocationSize = 10)
@Table(name = "PRPLRULEDETAILINFO")
public class PrpLRuleDetailInfo implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private PrpLRuleDetailInfoId id;
	...
	public PrpLRuleDetailInfoId getId() {
		return this.id;
	}

	public void setId(PrpLRuleDetailInfoId id) {
		this.id = id;
	}
