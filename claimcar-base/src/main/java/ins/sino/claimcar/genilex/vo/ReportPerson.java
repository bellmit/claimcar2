...
public class ReportPerson implements Serializable {
	...
	@XStreamAlias("ReporeCode")
	private String reporeCode;  //报案人代码
    ...
    public String getReporeCode() {
        return reporeCode;
    }

    
    public void setReporeCode(String reporeCode) {
        this.reporeCode = reporeCode;
    }
