...
public class Applicant implements Serializable {
	...
	@XStreamAlias("ApplicantCode")
	private String applicantCode;  //投保人编号
	
    @XStreamAlias("ApplicantName")
    private String applicantName;  //投保人名称
    
    @XStreamAlias("ApplicantType")
    private String applicantType;  //投保人类型
    
    @XStreamAlias("ApplicantNature")
    private String applicantNature;  //投保人性质代码
