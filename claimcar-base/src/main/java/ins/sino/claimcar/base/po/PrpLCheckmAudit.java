...
/**
* POJO Class PrpLCheckmAudit
*/
@Entity
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@TableGenerator(name = "utiSequence", table = "UTISEQUENCE", pkColumnName = "GenName", valueColumnName = "GenValue", pkColumnValue = "PK_PRPLCHECKMAUDIT", allocationSize = 10)
@Table(name = "PRPLCHECKMAUDIT")
public class PrpLCheckmAudit implements java.io.Serializable {
