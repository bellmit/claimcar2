...
/**
 * description: ClearBaseCacheServiceImpl
 * date: 2020/12/8 10:28
 * author: lk
 * version: 1.0
 */
@Service(protocol = {"dubbo"}, validation = "true", registry = {"default"}, group = "clearBaseCacheService")
@Path("clearBaseCacheService")
public class ClearBaseCacheServiceImpl implements ClearCacheService {
