...
/**
 * POJO Class PrpLWfTaskOut
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Table(name = "PRPLWFTASKOUT")
public class PrpLWfTaskOut implements java.io.Serializable {
	...
	private String flag;
	private String isMobileAccept; //是否移动端处理
	...
	@Column(name = "TASKOUTNODE", length=20)
	...
	@Column(name = "REGISTNO", nullable = false, length=10)
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "TASKOUTTIME", length=7)
	...
	@Column(name = "TASKOUTKEY", length=25)
	...
	@Column(name = "TASKOUTUSER", length=25)
	...
	@Column(name = "YWTASKTYPE", length=20)
	public String getYwTaskType() {
		return this.ywTaskType;
	}
	...
	@Column(name = "ISMOBILEACCEPT", length=2)
    ...
    @Column(name = "SUBCHECKFLAG", precision=2)
