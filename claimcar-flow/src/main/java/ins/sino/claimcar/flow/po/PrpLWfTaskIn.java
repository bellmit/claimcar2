...
@TableGenerator(name = "utiSequence", table = "UTISEQUENCE", pkColumnName = "GenName", valueColumnName = "GenValue", pkColumnValue = "PRPLWFTASK_PK", allocationSize = 2)
@Table(name = "PRPLWFTASKIN")
public class PrpLWfTaskIn implements java.io.Serializable {
	...
	@Column(name = "ISMOBILEACCEPT", precision=14)
