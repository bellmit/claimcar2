...
/**
 * description: ClearFlowCacheServiceImpl
 * date: 2020/12/8 15:06
 * author: lk
 * version: 1.0
 */
@Service(protocol = {"dubbo"}, validation = "true", registry = {"default"}, group = "clearFlowCacheService")
@Path("clearFlowCacheService")
public class ClearFlowCacheServiceImpl implements ClearCacheService {
    @Autowired
