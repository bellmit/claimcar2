/******************************************************************************
 * CREATETIME : 2016年5月26日 下午12:57:37
 ******************************************************************************/
...
public class SHCILossReqVehicleDataVo {
	...
	private List<SHCILossReqCarLossPartDataVo> carLossPartDataVo;// 车辆损失部位（多条）
	...
	private List<SHCILossReqFittingDataVo> fittingDataVo;// 车辆配件明细（多条）
	...
	private List<SHCILossReqRepairDataVo> repairDataVo;// 开票修理机构（多条）
	...
	private List<SHCILossReqActuralRepairDataVo> acturalRepairDataVo;// 承修修理机构（多条）
	...
	private String remnant;// 残值，保险公司预收回的残值的预估金额

	@XmlElement(name = "CHARG_4E_FEE")
	private String charg4eFee;// 管理费用，经销差率

	@XmlElement(name = "TOTAL_WORKING_HOUR")
	private String totalWorkingHour;// 配件总工时
	 ...
	 */
	public void setCharg4eFee(String charg4eFee) {
	...
	public List<SHCILossReqCarLossPartDataVo> getCarLossPartDataVo() {
		return carLossPartDataVo;
	}

	public void setCarLossPartDataVo(List<SHCILossReqCarLossPartDataVo> carLossPartDataVo) {
		this.carLossPartDataVo = carLossPartDataVo;
	}

	public List<SHCILossReqFittingDataVo> getFittingDataVo() {
		return fittingDataVo;
	}

	public void setFittingDataVo(List<SHCILossReqFittingDataVo> fittingDataVo) {
		this.fittingDataVo = fittingDataVo;
	}

	public List<SHCILossReqRepairDataVo> getRepairDataVo() {
		return repairDataVo;
	}

	public void setRepairDataVo(List<SHCILossReqRepairDataVo> repairDataVo) {
		this.repairDataVo = repairDataVo;
	}

	public List<SHCILossReqActuralRepairDataVo> getActuralRepairDataVo() {
		return acturalRepairDataVo;
	}

	public void setActuralRepairDataVo(List<SHCILossReqActuralRepairDataVo> acturalRepairDataVo) {
