...
/**
 * 查勘、定损、核损请求上海平台信息BodyVo类-交强
 * @author ★Luwei
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "BODY")
public class SHCILossReqBodyVo {

	/**
	 * 基本信息
	 */
	@XmlElement(name = "BASE_PART")
	private SHCILossReqBasePartVo basePartVo;
	...
	public SHCILossReqBasePartVo getBasePartVo() {
		return basePartVo;
	}

	public void setBasePartVo(SHCILossReqBasePartVo basePartVo) {
