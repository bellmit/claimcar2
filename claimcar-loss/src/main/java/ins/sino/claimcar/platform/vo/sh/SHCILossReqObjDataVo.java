/******************************************************************************
 * CREATETIME : 2016年5月26日 下午2:27:47
 ******************************************************************************/
...
/**
 * 物损损失情况（多条）OBJ_LIST
 * @author luwei sinosoft.
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class SHCILossReqObjDataVo {

	@XmlElement(name = "OBJECT_DESC", required = true)
	...
	private String lossAmount;// 损失金额（单价）
