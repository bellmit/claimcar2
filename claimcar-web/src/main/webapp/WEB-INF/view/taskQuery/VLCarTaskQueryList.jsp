...
<body>
		...
		<div class="table_wrap">
			<div class="table_cont pd-10">
				<div class="formtable f_gray4">
					<form id="form" name="form" class="form-horizontal" role="form" method="post" action="#">
					...
					<input type="hidden"  name="subNodeCode"  value="${subNodeCode }" >
						...
						<div class="row mb-3 cl">
						 <label class="form-label col-1 ">车架号</label>
							...
							<label class="form-label col-1 ">紧急程度</label>
							<div class="formControls col-3">
								<span class="select-box">
							...
							<label class="form-label col-1">定损类型</label>
							<div class="formControls col-3">
								<span class="select-box"> 
									 <select name="taskInNode" class=" select ">
										...
										<option value="DLAdd">追加定损</option>
										
										<option value="DLMod">定损修改</option>
										<option value="DLChk">复检</option>
									</select>
								</span>
							</div>
						</div>
	...
	function rowCallback(row, data, displayIndex, displayIndexFull) {
		...
		$('tr', row).addClass("text-c");
		if(data.taskInNode=="ChkRe"){
			if(handleStatus1=='0'||handleStatus1=='3'){
			   $('td:eq(10)', row).html("是");
			}else if(handleStatus1=='2'){
				$('td:eq(9)', row).html("是");
			}else{
				$('td:eq(11)', row).html("是");
			}
		...
		var columns0= [
			...
			{"data" : "isRecheck"}, //是否复勘提交
			{"data" : "taskInNodeName"}, //任务类型
