	...
	<div class="page_wrap">
		...
		<div class="table_wrap">
			...
			<div id="tab-system" class="HuiTab">
				<div class="tabBar cl"> 
					<span onclick="changeHandleTab(0)"><i class="Hui-iconfont handun">&#xe619;</i>未处理</span>
...
<script type="text/javascript" src="${ctx }/js/flow/flowCommon.js"></script>
	...
	<script type="text/javascript">
		...
		function search(){
					...
					if(handleStatus == '0'){
						ajaxList.targetUrl = '/claimcar/taskQuery/RecanAppTaskQuery.do';// + $("#form").serialize();
					}else{
