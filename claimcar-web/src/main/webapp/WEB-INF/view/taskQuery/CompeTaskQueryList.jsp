			...
			<div class="table_cont pd-10">
				<div class="formtable f_gray4">
						...
						<div class="row mb-3 cl">
							...
							<div class="formControls col-3">
								<span class="select-box"> 
									<app:codeSelect codeType="ComCodeLv2" type="select" id="comCode" name="comCode" lableType="code-name" />
								</span>
							</div>
						...
						<div class="row mb-3 cl">
							...
							<div class="formControls col-3">
								<%-- <span class="select-box"> <app:codeSelect
										codeType="CompensateKind" type="select" name="compensateKind"
										lableType="code-name" />
								</span> --%>
								 <span class="select-box"> 
		...
		function rowCallback(row, data, displayIndex, displayIndexFull) {
			...
			if(handleStatus1=='0'){
				if(data.handlerIdKey!=null){
					  $('td:eq(4)',row).html("<a onclick=prePayToclaimView('"+data.handlerIdKey+"','"+data.registNo+"');>"+data.handlerIdKey+"</a>");
				}	
			}else{
			...
			if(handleStatus1!='0'){
				if(data.compensateNo!=null){
					$('td:eq(2)',row).html("<a onclick=thisToCompenView('"+data.registNo+"','"+data.compensateNo+"');>"+data.compensateNo+"</a>");
				}
			}
