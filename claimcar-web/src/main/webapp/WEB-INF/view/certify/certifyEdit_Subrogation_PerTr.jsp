	...
	<tr class="text-c">
		...
		<td>
			<div class="row cl">
				...
				<div class="form_input col-3">
					<input type="text" style="width: 80%" class="input-text" name="subrogationMain.prpLSubrogationPersons[${personSize}].linkerName" value="${personVo.linkerName }" />
				</div>
			</div>	
		</td>
		</tr>
		<tr class="text-c">
			...
			<div class="row cl">
				...
				<div class="form_input col-3">
					<input type="text" style="width: 80%" class="input-text" name="subrogationMain.prpLSubrogationPersons[${personSize}].phone" value="${personVo.phone }" />
					<font class="must">&nbsp;</font>
				</div>
