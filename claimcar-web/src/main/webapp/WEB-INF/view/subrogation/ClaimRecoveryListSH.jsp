...
<body>
	...
	var columns = [ 
		{"data" : null},
		{"data" : null},
		{"data" : "recoveryCodeStatus"},
		{"data" : "lossTime"}, 
		{"data" : "oppoentInsurerCode"},
		{"data" : "oppoentInsurerArea"}, 
		{"data" : "coverageType"},
		{"data" : "sumRealAmount"},
		{"data" : "sumRealAmount"},
		{"data" : "sumRealAmount"}
	...
	function rowCallback(row, data, displayIndex, displayIndexFull) {
		...
		var parmas = "'"+data.recoveryCode +"'";

		$('td:eq(1)', row).html("<a href='javascript:' onclick=isShowView("+parmas+")>"+data.recoveryCode+"</a>");
	}
	...
	function isShowView(accountsNo) {
		var index="0";//结算码是否失效的标志
		var url = "/claimcar/subrogationEdit/isShowView.ajax";
		var params = {
		...
		var parmasData = ""+accountsNo +"";
		var goUrl="/claimcar/subrogationEdit/showQsConfirmInfo.do?accountsNo="+parmasData;
		openTaskEditWin("代位求偿待清算金额确认信息",goUrl);
	}
