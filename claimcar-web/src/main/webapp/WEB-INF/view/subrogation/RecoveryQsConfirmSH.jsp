	...
	<div class="table_title f14">代位求偿待结算金额确认信息</div>
		<div class="formtable">
			<form id="confirmform" name="confirmform" class="form-horizontal" role="form" method="post">
				<input type="hidden" name="recoveryCode" id="recoveryCode" value="${accountsInfoVo.accountsNo }"/>
				<input type="hidden" name="realAmount" value="${accountsInfoVo.compensateAmount }"/>
				<input type="hidden" id="accountsNoStatus" value="${accountsInfoVo.accountsNoStatus }"/>
				...
				<div class="text-c">
					<input type="button" class="btn btn-primary" id="button" value="待结算金额确认" />
				</span><br />
			</div>
		</form>			
	</div>
	<script type="text/javascript" src="/claimcar/js/subrogation/recoveryConfirmSH.js"></script>	
