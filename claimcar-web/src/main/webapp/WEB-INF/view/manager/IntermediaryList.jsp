...
<div class="page_wrap" id="fu">
				...
				<form id="form" class="form-horizontal" role="form" method="post">
					<div class="formtable f_gray4">
						<div class="row mb-3 cl">
							<label for=" " class="form_label col-2">公估机构代码</label>
							<div class="form_input col-2">
								<input id=" " type="text" class="input-text" name="prpdIntermMainVo.IntermCode"/>
							</div>
							
							<label for=" " class="form_label col-2">公估机构名称</label>
							<div class="form_input col-2">
								<input id=" " type="text" class="input-text" name="prpdIntermMainVo.IntermName"/>
							</div>
	...
	var columns = [
		       		{
		       			...
		       			"data" : "prpdIntermBank.bankNameName"
		       		},{
		       			"data" : "prpdIntermBank.accountNo"
		       		},{
		       			"data" : null
		       		}
		       	  ];
	...
	function modifiInterm(modifiId){		
		...
		index=layer.open({
		    ...
		    skin: 'yourclass',
		    area: ['1100px', '550px'],
		    content:"/claimcar/manager/intermediaryEdit.do?Id="+modifiId+"&flag="+flag,
		    end:function(){
		    	$("#search").click();
		    }
		});
	...
	function add(){
		index=layer.open({
		    ...
		    skin: 'yourclass',
		    area: ['1100px', '550px'],
		    content:"/claimcar/manager/intermediaryEdit.do",
		    end:function(){
		    	$("#search").click();
		    }
		});
	...
	$(function(){
		...
		$("#search").click(
			function() {
				...
				ajaxList.targetUrl = "/claimcar/manager/intermediaryFind.do";
