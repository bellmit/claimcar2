...
<div class="page_wrap" id="fu">
						...
						<div class="row mb-3 cl">
							<label for="factoryType" class="form_label col-2">代理人名称</label>
					 		<div class="form_input col-3">
					 			<input id="agentName" type="text" class="input-text"  name="prpLAgentFactoryVo.agentName" />
					 		</div>
	...
	function rowCallback(row, data, displayIndex, displayIndexFull) {
		$('td:eq(2)', row).html("<button class='btn btn-primary' onclick=Choose('"+data.agentName+"','"+data.agentCode+"');>选择</button>");
	}
	...
	$(function() {
		...
		ajaxList.targetUrl = "/claimcar/manager/prpLAgentFactoryFind.do";
		ajaxList.columns = columns;
		ajaxList.rowCallback = rowCallback;
		$("#search").click(function() {
			if(!checkNull($("#agentName").val())  && !checkNull($("#agentCode").val())) {
