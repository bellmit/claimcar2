		...
		<div id="subRiskDiv">
			<div class="table_cont">
				<table class="table table-border" id="subRiskTab">
					...
					<tbody>
						<c:forEach var ="item" items="${showMap }">
							<tr style="cursor: pointer;">
							<td align="center"><input name="subRiskCheckFlag" type="checkbox" value="${item.key }"></td>
			...
			<div class="text-c">
				<button type="button" onclick="loadOtherPropTr();" class="btn btn-primary">确定</button>
