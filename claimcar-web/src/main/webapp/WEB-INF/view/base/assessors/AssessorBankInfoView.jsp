		...
		<div class="formtable mt-10">
			<div class="row cl">
				...
				<div class="form_input col-2">
					<input type="text" class="input-text" name="prpdIntermBankVo.AccountName" value="${prpdIntermBank.accountName}"  id="accountname" readonly="readonly"/>
				...
				<div class="form_input col-2 ">
					<input type="text" class="input-text"
						name="prpdIntermBankVo.AccountNo" value="${prpdIntermBank.accountNo}"  id="account" readonly="readonly"/>
				</div>
				<span class="c-red col-1">*</span>
			</div>
			...
			<div class="row cl">
				...
				<div class="form_input col-2">
					<input type="text" class="input-text"
						name="prpdIntermBankVo.CertifyNo" value="${prpdIntermBank.certifyNo}" id="certifyNo" readonly="readonly"/>
				</div>
				<span class="c-red col-1">*</span>
				...
				<div class="form_input col-2">
					<input type="text" class="input-text"
						name="prpdIntermBankVo.Mobile" value="${prpdIntermBank.mobile}"  id="accountcellphone" datatype="m|/^0\d{2,3}-\d{7,8}$/" readonly="readonly"/>
				</div>
				<span class="c-red col-1">*</span>
			</div>
			<div class="row cl">
				  <label class="form_label col-3"><font class="c-red">*</font>公私标志：</label>
				   <div class="form_input col-2">
					  <app:codeSelect codeType="publicAndPrivate" name="prpdIntermBankVo.publicAndPrivate" value="${prpdIntermBank.publicAndPrivate}" id="publicAndPrivate" type="select" clazz="must" disabled="true"/>
				   </div>
		   </div>
		</div>
		<p>
		...
		<div class="formtable mt-5">
			<div class="row cl">
				...
				<div class="form_label col-6" style="text-align: left">
					...
					<app:areaSelect targetElmId="intermBankProvCity" showLevel="2" style="width:190px" areaCode="${prpdIntermBank.city}" isAreaCode="Y" disabled="true"/>
			...
			<div class="row cl">
				...
				<div class="form_input col-2">
					...
					<app:codeSelect codeType="" type="select" id="BankName" name="prpdIntermBankVo.BankName" lableType="name" value="${prpdIntermBank.bankName}" dataSource="${bankCodeMap}" disabled="true"/>
					</span>
				</div>
		...
		<div class="formtable">
			<div class="row cl">
				...
				<div class="form_input col-2">
					<input type="text" class="input-text"
						...
						readonly value="${prpdIntermBank.bankOutlets}" readonly="readonly"/>
				</div>
				...
				<div class="form_input col-2 ml-5">
					<input type="text" class="input-text"
						...
						readonly value="${prpdIntermBank.bankNumber}" readonly="readonly"/>
				</div>
				<span class="c-red col-1">*</span>
			</div>
			...
			<div class="row cl">
			  <label class="form_label col-3"><font class="c-red">*</font>摘要：</label>
				...
				<input type="text" datatype="*1-1000"  class="input-text" value="${prpdIntermBank.remark}" name="prpdIntermBankVo.remark" readonly="readonly"/>
				</div>
			</div>
		</div>
		</br>
