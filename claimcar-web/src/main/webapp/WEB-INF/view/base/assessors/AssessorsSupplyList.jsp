	...
	<div class="page_wrap">
		...
		<script type="text/javascript">
			...
			function rowCallback(row, data, displayIndex, displayIndexFull) {
				...
				$('td:eq(6)',row).html("<button class ='btn btn-primary btn-outline' onclick=supplment('"+ data.registNo +"'," + data.taskType + "," + data.bussId + ",'"+ data.userName +"')>补录</button>");
			}
			function search() {
				var ajaxList = new AjaxList("#resultDataTable");
				ajaxList.targetUrl = '/claimcar/assessors/assSupplymentSerach';
			...
			function supplment(registNo,taskType,bussId,userCode){
				var url = "/claimcar/assessors/supplementAssessors";
				var param = {
						"mainId": bussId,
						"registNo": registNo,
						"taskType": taskType,
