...
function rowCallback(row, data, displayIndex, displayIndexFull) {
	$('td:eq(0)', row).html("<a  onclick=intermAuditMoreMessage('"+data.bussNo+"','"+data.accountId+"','"+data.backaccountId+"','"+data.intermCode+"','"+data.registNo+"','"+data.auditId+"');>"+data.bussNo+"</a>");
...
function search(){
	...
	ajaxList.targetUrl ='/claimcar/assessors/assessorFeeAccountAuditSearch.do';
...
/* function intermMoreMessage(bussNo,accountId){
...
//本案件下，公估费费用查看yzy
var assessor_index;
function intermAuditMoreMessage(bussNo,accountId,backaccountId,intermCode,registNo,auditId) {
	var url = "/claimcar/assessors/assessorAuditMoreMessageList.do?bussNo="+bussNo+"&accountId="+accountId+"&backaccountId="+backaccountId+"&intermCode="+intermCode+"&registNo="+registNo+"&auditId="+auditId;
