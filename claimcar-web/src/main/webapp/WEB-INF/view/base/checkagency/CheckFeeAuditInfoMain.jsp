...
<body>
	<div class="fixedmargin page_wrap">
		<div class="table_cont">
			...
			<input type="hidden"  name="intermCode" id="intermCode" value="${checkCode}"/>
			...
			<input type="hidden"  name="autidStatus" id="autidStatus" value="${prpLCheckmAuditVo.status}" />
				...
				<div class="table_wrap">
					...
					<div class="table_cont">
						<div class="formtable">
							...
							<div class="row cl">
							    <label class="form_label col-2">查勘机构：</label>
								<div class="form_input col-2">${checkname}</div>
		...
		<textarea class="textarea h100" id="contexts" maxlength="255"
					...
					placeholder="请输入...">${prpLCheckmAuditVo.auditOpinion}</textarea>
		</div>
		</form>
		</br>
		<div class="text-c mt-10">
	...
	<script type="text/javascript">
		...
		function assAditPayCustomView(auditId){
			...
			paycustom_url="/claimcar/checkfee/checkFeeAuditBankInfoQuery?auditId="+auditId;
			layer.open({
				type : 2,
				title : '银行信息查看',
				shade : false,
		...
		function saveAcc(auditId,sign){
			...
			var params = $("#accountForm").serialize();
			 var url="/claimcar/checkfee/auditWays";
			$.ajax({
				url : url, // 后台校验
				type : 'post', // 数据发送方式
