...
function rowCallback(row, data, displayIndex, displayIndexFull) {	
	$('td:eq(0)', row).html("<a  onclick='checkVeri("+data.taskId+");'>"+data.registNo+"</a>");
...
function search(){
			...
			ajaxList.targetUrl = '/claimcar/checkfee/checkFeeVeriTaskQuery.do';// + $("#form").serialize();
