	...
	<div class="page_wrap">
		<div class="table_cont">
					...
					<div class="formtable tableoverlable">
						<div class="row mb-3 cl">
							...
							<div class="formControls col-3">
								<app:codetrans codeType="FlowNode"
									codeCode="${logVo.operateNode}" />
							</div>
						...
						<div class="row mb-3 cl">
							...
							<div class="formControls col-3">${logVo.registNo}</div>
							<label class="form-label col-1 text-c">立案号:</label>
							<div class="formControls col-3">${logVo.claimNo}</div>
						</div>
						<div class="row mb-3 cl">
			...
			<div class="table_wrap">
				...
				<textarea class="textarea h100" readonly="readonly"
					placeholder="请输入...">${resXml}</textarea>
			</div>
			<!-- 底部按钮 -->
			<input style="margin-left: 40%;" class="btn btn-primary btn-kk"
				type="button" onclick="interfaceReload('${logVo.id}')" value="补传" />
			<input class="btn btn-primary btn-kk" type="button"
				onclick="closeLayer()" value="返回" />
		</div>
	</div>

	<script type="text/javascript">
		function interfaceReload(logId){
			var url = "/claimcar/interfaceLog/interfaceReload.do";
