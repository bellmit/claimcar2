	...
	<div class="fixedmargin page_wrap">
		<form id="defossform" role="form" method="post" name="fm">
		    ...
		    <input type="hidden" name="prpLUserHolidayVo.createTime" 
		         value="<fmt:formatDate value='${prpLUserHolidayVo.createTime}' pattern='yyyy-MM-dd'/>" />
					...
					<div class="table_cont">
						<div class="formtable">
							<div class="row cl">
								...
								<div class="form_input col-2">
									<input type="text" class="input-text"
										name="prpLUserHolidayVo.userName" value="${prpLUserHolidayVo.userCode }"
										readonly="readonly" />
								</div>
								<label class="form_label col-2">归属机构</label>
								<div class="form_input col-2">
									<input type="text" class="input-text"
										name="prpLUserHolidayVo.comCode" value="${prpLUserHolidayVo.userCode}"
