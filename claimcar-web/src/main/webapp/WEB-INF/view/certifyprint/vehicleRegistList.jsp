...
<div class="page_wrap" id="fu">
			...
			<div class="table_cont mb-10">
				<form id="form" class="form-horizontal" role="form" method="post">
					<div class="formtable f_gray4">
						...
						<div class="row mb-3 cl">
							<label for=" " class="form_label col-2">被保险人</label>
							<div class="form_input col-3">
								<input id=" " type="text" class="input-text" name="insuredName"/>
							</div>
							
							<label for=" " class="form_label col-2">车牌号码</label>
							<div class="form_input col-3">
								<input id=" " type="text" class="input-text" name="licenseNo" />
							</div>
						</div>
						<p>
						<div class="line"></div>
	...
	function rowCallback(row, data, displayIndex, displayIndexFull) {	
		$('td:eq(4)', row).html("<input type='button' class='btn btn-primary' value='打印'   onclick='certifyPrintp(\""+data.registNo+"\");'>");
	}
	...
	function certifyPrintp(registNo1){
	...
	$(function(){
		...
		$("#search").click(
			function() {
				...
				ajaxList.targetUrl = "/claimcar/certifyPrintSearch/vehicleRegistListSearch.do";
