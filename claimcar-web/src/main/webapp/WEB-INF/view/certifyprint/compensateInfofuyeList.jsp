...
function certifyPrintp(registNo1,compensateNo1){
	...
	/* function certifyPrint(registNo,compensateNo){
		...
		var url = "/claimcar/certifyPrint/compensateInfofuye.ajax";
	...
	$(function(){
		...
		$("#search").click(
			function() {
				...
				ajaxList.targetUrl = "/claimcar/certifyPrintSearch/compensateInfofuyeListSearch.do";
