...
<div class="page_wrap" id="fu">
	...
	function rowCallback(row, data, displayIndex, displayIndexFull) {	
		$('td:eq(3)', row).html("<input type='button' class='btn btn-primary' value='打印'   onclick='certifyPrintp("+data.id+",\""+data.registNo+"\");'>");
	}
	function certifyPrintp(mainId,registNo1){
	...
	/* function certifyPrint(mainId,registNo){
	...
	$(function(){
		...
		$("#search").click(
			function() {
				...
				ajaxList.targetUrl = "/claimcar/certifyPrintSearch/lossCarListSearch.do";
