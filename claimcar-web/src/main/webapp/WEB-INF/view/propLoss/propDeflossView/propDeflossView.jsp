...
<html>
	...
	<body>			
		<div class="top_btn">
				<a class="btn  btn-primary">历史出险信息（4）</a>
				<a class="btn  btn-danger">风险提示信息</a>
				<a class="btn  btn-primary">案件备注（4）</a>
				<a class="btn  btn-disabled">多保单关联与取消</a>
				<a class="btn  btn-primary">无保转有保</a>
				<a class="btn  btn-primary">客户信息</a>
		</div>
		<div class="fixedmargin page_wrap">
			<div id="tab_demo" class="HuiTab">
				  <div class="tabBar cl"><span>当前定损</span><span>损失信息</span></div>	
				 	<!--选项卡一 -->			
				 	<div class="tabCon"> 	
				 		<form action="" method="get" id="lossform" role="form">
						 	<%@include file="propBaseInfo.jspf" %>
							<%@include file="propDamageInfo.jspf" %> 	
							<%@include file="FeePayInfo.jspf" %> 
				   		<%@include file="propRescueInfo.jspf" %>
				   		<%@include file="DeflossOp.jspf" %>
			...
			<div class="text-c">
				<input class="btn btn-default radius" id="returnMain"  value="返回" />
			</div>
			</form>
		</div>
		</div>
