					...
					<form id="form" name="form" class="form-horizontal" role="form" method="post">
						...
						<div class="row mb-3 cl">
							...
							<label class="form-label col-1 text-c">操作人</label>
							    <div class="formControls col-3">
							        <input type="text" class="input-text" value="${userName}" readonly="readonly" />
							    </div>
						</div>
						<!-- <div class="line"></div> -->
...
function rowCallback(row, data, displayIndex, displayIndexFull) {
	...
	if(isVerify != "1" && handleStatus=='0'){
		...
		$('td:eq(0)', row).html("<a onclick=accountInfo('"+data.compensateNo+"','"+data.registNo+"','"+data.payeeId+"','"+data.chargeCode+"','"+data.payType+"','"+data.serialNo+"');>"+data.compensateNo+"</a>");
	}
}
...
function search(){
	...
	ajaxList.targetUrl = '/claimcar/accountQueryAction/accountSearch.do';
