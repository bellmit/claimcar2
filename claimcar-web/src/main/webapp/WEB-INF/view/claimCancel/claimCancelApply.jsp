...
<div class="page_wrap">
			...
			<div id="tab-system" class="HuiTab">
				<div class="tabCon clearfix">
						...
						<c:forEach var="prpLClaimVo" items="${prpLClaimVoList}" varStatus="status">
						  <tr>
						     	<%-- <td><input type="checkbox" value="${prpLClaimVo.claimNo}" name="claimNo"></td>  --%>
	...
	function save(){
		...
		var s="";
		var obj=document.getElementsByName('claimNo'); 
		...
		var goUrl ="/claimcar/claim/claimCancelInit.do?claimNo="+a+"&taskId="+taskId+"&workStatus=";
		
		openTaskEditWin("立案注销拒赔处理",goUrl);
		/* $.ajax({
			 url : '/claimcar/claim/claimCancelInit.do?claimNo='+a+'&taskId='+taskId,
			 type : 'post', // 数据发送方式
