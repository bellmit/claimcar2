		...
		<div class="formtable">
			<div class="row cl">
				...
				<div class="form_input col-3">
					...
					<input class="btn ml-5" id="" onclick="" type="button" value="...">  
				</div>
			</div>
			<div class="row cl">
				...
				<div class="form_input col-3">${prpLRegistVo.damageCode }</div>
			...
			<div class="row cl">
				...
				<div class="form_input col-2">${prpLRegistExtVo.checkAddressCode}</div>
			</div>
			<div class="row cl">
				...
				<div class="form_input col-3">${prpLRegistVo.reportorRelation}</div>
			</div>
			<div class="row cl">
				...
				<div class="form_input col-2">${prpLRegistVo.mercyFlag}</div>
			...
			<div class="row cl">
				...
				<div class="form_input col-2">${prpLClaimVo.claimType}</div>
