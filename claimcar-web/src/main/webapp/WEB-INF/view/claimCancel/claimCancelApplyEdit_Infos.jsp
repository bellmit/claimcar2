	...
	<div class="table_cont">
		<div class="formtable">
			<div class="row cl">
				...
				<div class="form_input col-2">${prpLClaimVo.policyNo }</div>
			...
			<div class="row cl">
				...
				<div class="form_input col-2">${prpLCMainVo.insuredName }</div>
				<label class="form_label col-2">客户等级</label>
				<div class="form_input col-2">${prpLRegistVo.customerLevel}</div>
			</div>
			<div class="row cl">
				<label class="form_label col-2">保险币别</label>
				<div class="form_input col-2">${prpLCMainVo.currency }</div>
				<label class="form_label col-2">保险金额</label>
				<div class="form_input col-2">25777785</div>
				<label class="form_label col-2">调度次数</label>
				<div class="form_input col-2">1</div>
			</div>
			<div class="row cl">
				...
				<div class="form_input col-2"><app:codetrans codeType="ComCode" codeCode="${prpLCMainVo.comCode}" /></div>
			</div>
						<div class="row cl">
	...
	<div class="table_cont">
		<div class="formtable">
			<div class="row cl">
				...
				<div class="form_input col-2">${prpLCMainVo.registNo }</div>
				...
				<div class="form_input col-2">
					...
					<label class="form_label col-2">出险区域</label>
				<%-- <div class="form_input col-2">${prpLRegistVo.damageAreaCode } </div> --%>
			...
			<div class="row cl">
				...
				<div class="form_input col-2">${prpLRegistVo.reportorPhone}</div>
				<label class="form_label col-2">与被保险人关系</label>
				
				<div class="form_input col-2"><app:codetrans codeType="InsuredIdentity" codeCode="${prpLRegistVo.reportorRelation}"/></div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formtable">
					<div class="row cl">
					出险经过说明:
					<div class="col-12">${prpLRegistExtVo.dangerRemark}</div>
					</div>
				</div>
