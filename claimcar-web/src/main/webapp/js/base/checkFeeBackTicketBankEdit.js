var index2 = null;
 ...
 var ajaxEdit = new AjaxEdit($('#saveBankInfo'));
    ajaxEdit.targetUrl = "/claimcar/checkfee/sendCheckFeeAccountToPayment";
 ...
 function layerShowBankNum(){//弹出检索行号页面
		...
		var Prov = $("#checkBankProvCity_lv1  option:selected").text();
		var City = $("#checkBankProvCity_lv2  option:selected").text();
